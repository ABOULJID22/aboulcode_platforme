...
<head>
    ...
    <style type="text/css">
        ...
        .btn { display:inline-block; background:#2563eb; color:#ffffff; padding:12px 18px; border-radius:8px; font-weight:700; text-decoration:none; }
        ...
        <div class="email-container" role="article" aria-roledescription="email" aria-label="Réinitialisation du mot de passe">
            <div class="email-header">
                <div class="brand">
                    ...
                    <h1>OrientationTech — Réinitialisation</h1>
                </div>
            </div>
            ...
            <div class="email-footer">
                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
                    <div>Envoyé automatiquement par OrientationTech.</div>
                    <div><a href="https://Orientationtech.ma" class="btn">Visiter le site</a></div>
                </div>
            </div>
        </div>
    </div>
